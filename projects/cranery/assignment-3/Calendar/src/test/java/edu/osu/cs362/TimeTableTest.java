...
apts.add(appt);
							...
							appt = new Appt(startHour,
									  ...
									  assertTrue(thrown);
										assertEquals(week.deleteAppt(apts,appt),apts);
										...
										assertEquals(null,week.deleteAppt(apts,appt));
	 ...
	 @Test
	  public void test02()  throws Throwable  {
			...
			GregorianCalendar cai = new GregorianCalendar(2017,3,23);
			GregorianCalendar ca1 = new GregorianCalendar(2017,3,24);
			GregorianCalendar cae = new GregorianCalendar(2017,3,22);
			GregorianCalendar cao = new GregorianCalendar(2017,3,25);
			LinkedList<Appt> apts= new LinkedList<Appt>();
			LinkedList<CalDay> days = new LinkedList<CalDay>();
			int startHour=13;
			int startMinute=30;
							...
							appt = new Appt(startHour,
											...
											description="meet at orupa.";
											 appt = new Appt(startHour,
															...
															apts.add(appt);
										TimeTable week = new TimeTable();
										assertEquals(week.getApptRange(apts,cae,cao).toString(),days.toString());
